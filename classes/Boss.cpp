...
void Boss::updateAnimations() {
    ...
    // Animacion IDLE
    switch(animState) {
        case (BOSS_ANIMATION_STATES::IDLE1):
            moving = false;
            invincible = false;
            ...
            break;
        case (BOSS_ANIMATION_STATES::MOVING):
            if (animationTimer.getElapsedTime().asSeconds() >= 0.15f) {
            ...
            break;
        case (BOSS_ANIMATION_STATES::TAKEHIT):
            ...
            break;
        case (BOSS_ANIMATION_STATES::SHOOTING):
            ...
            break;
        case (BOSS_ANIMATION_STATES::DEAD):
